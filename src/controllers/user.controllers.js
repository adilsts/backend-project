...
const registerUser = asynchandlers(async (req, res )=> {
    ...
    if(existedUser){
        throw new ApiError(409, "User with email or usrername already exist")
    }
...
const logoutUser = asynchandlers(async (req, res) => {
   ...
   await User.findByIdAndUpdate(
    ...
    return res.status(200).clearCookie("accessToken", options).clearCookie("accessToken", options).
...
const changeCurrentPassword = asynchandlers(async (req, res) => {
    ...
    return res.status(200).json(new ApiResponse(200, {}, "Old Password is changed"))
})
...
const updateCoverImg = asynchandlers(async(req, res)=> {
...
export {registerUser,
    loginUser , logoutUser , refreshAccessToken , changeCurrentPassword , getCurrentUser , updateAccountDetails, updateUserAvatar , updateCoverImg
}